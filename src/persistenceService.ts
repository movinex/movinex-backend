      ...
      .insert([
        {
          ...
          imagenes_popup: Array.isArray(datos.imagenes_popup) ? datos.imagenes_popup : [],
          gradiente_inicio: datos.gradiente_inicio || null,
          gradiente_fin: datos.gradiente_fin || null,
